 ...
 */
class Chilli_Featured_Galleries extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname'   => 'widget_featured_galleries',
			'description' => _x( 'Enter ids of galleries you want to feature.', 'Description of the featured galleries widget', 'chillitheme' )
		);
		parent::__construct( 'featured-galleries', _x( 'Featured Galleries', 'Name of the featured galleries widget', 'chillitheme' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		foreach ( $gallery_ids as $gallery_id ) {
			...
			if ( $post && $format == 'gallery' ) {
				...
				$images                                           = chilli_get_gallery_images( $gallery_id );
	...
	public function form( $instance ) {
		...
		<p><label
				for="<?php echo $this->get_field_id( 'gallery_ids' ); ?>"><?php _e( 'Comma seperated ids of galleries you want to feature:', 'chillitheme' ); ?></label>
